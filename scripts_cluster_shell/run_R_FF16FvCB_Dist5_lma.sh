...
#SBATCH -e run_R_Dist5_vpd_lma%j.err
...
R CMD BATCH "--args vpd=${SLURM_ARRAY_TASK_ID}" scripts_cluster_R/assembly_FF16FvCB_Dist5_vpd_lma.R FF16FvCB_Dist5_vpd_lma${SLURM_ARRAY_TASK_ID}.out
