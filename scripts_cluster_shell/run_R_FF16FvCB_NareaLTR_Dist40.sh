#!/bin/sh
#SBATCH --job-name=run_R_NareaLTR_Dist40_vpd
#SBATCH -p q-128Go
...
R CMD BATCH "--args vpd=${SLURM_ARRAY_TASK_ID}" scripts_cluster_R/assembly_FF16FvCB_NareaLTR_Dist40_vpd.R FF16FvCB_NareaLTR_Dist40_vpd${SLURM_ARRAY_TASK_ID}.out
