...
I propose to use the parametrisation of \citet{Marechaux-2017}. NEED TO CHECK!!!


\subsection{Parametrisation of $J_{max}$ \texit{vs.} $V_{cmax}$}
...
\item according to \citet{Medlyn-2002} Jmax = 1.67 Vcmax
...
\caption{\textbf{Different parametrization of teh link between $N_{area}$ and $V_{cmax}$.}
