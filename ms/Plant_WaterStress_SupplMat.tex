...
\caption{\textbf{Link between $N_{area}$ and intercept (B_kl1) and slope (B_kl2) of the LMA vs leaf turnover tradeoff (using 14 bins of $N_{area}$ with equal number of observations per bin.}
